...
# Restaura o backup do banco "exercise2_sql", criando o banco se necessário
pg_restore -U nome_usuario -d nome_banco --create -v ~/caminho/do/arquivo.backup
pg_restore -U postgres -d exercise2_sql --create -v "C:\Users\Alisson Pereira\Documents\backup\exercise2_sql.backup"

# Semelhante ao primeiro, mas usa o banco "postgres" para criar o novo banco
pg_restore --create -d postgres -v "C:\Users\Alisson Pereira\Documents\backup\exercicio2_sql.backup"
