...
3. Criar um arquivo principal para a aplicação que deve instanciar as duas classes criadas anteriormente e desenvolver 
e chamar cada um dos métodos desenvolvidos de acordo com a opção escolhida.
"""

from Exercicios.contato import Contact
from Exercicios.contato_agenda import ContactBook
